    ...
    <div class="mt-4">
      <div class="flex items-center justify-between mb-2">
        ...
        {props.globalBlockedDates.length > 0 && (
          <span class="text-xs text-red-500">{props.globalBlockedDates.length} blocked day{props.globalBlockedDates.length !== 1 ? 's' : ''}</span>
        )}
      </div>
              ...
              {(week) => {
                ...
                return (
                  <tr>
                    ...
                    <For each={week}>
                      {(dateISO) => {
                        const inRange = () => dateISO >= props.startDate && dateISO <= props.endDate
